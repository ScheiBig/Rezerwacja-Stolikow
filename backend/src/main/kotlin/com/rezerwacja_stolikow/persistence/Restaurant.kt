...
object Restaurant {
    ...
    object Table: LongIdTable("restaurants") {
        ...
        val mondayOpen = varchar("monday__open", 8)
        val mondayClose = varchar("monday__close", 8)
        val tuesdayOpen = varchar("tuesday__open", 8)
        val tuesdayClose = varchar("tuesday__close", 8)
        val wednesdayOpen = varchar("wednesday__open", 8)
        val wednesdayClose = varchar("wednesday__close", 8)
        val thursdayOpen = varchar("thursday__open", 8)
        val thursdayClose = varchar("thursday__close", 8)
        val fridayOpen = varchar("friday__open", 8)
        val fridayClose = varchar("friday__close", 8)
        val saturdayOpen = varchar("saturday__open", 8)
        val saturdayClose = varchar("saturday__close", 8)
        val sundayOpen = varchar("sunday__open", 8)
        val sundayClose = varchar("sunday__close", 8)
